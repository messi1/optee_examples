...
void AesSecureStorageFacade::encryptFile(const std::string &key_id,
                                         const std::string &in_file,
                                         const std::string &out_file) {
  file_crypto_.encrypt(key_id, in_file, out_file);
}

void AesSecureStorageFacade::decryptFile(const std::string &key_id,
                                         const std::string &in_file,
                                         const std::string &out_file) {
